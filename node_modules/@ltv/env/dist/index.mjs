...
function stringToArray(str) {
  if (!hasUnicode(str)) return str.split("");
  const result = [];
  let match;
...
function trim(str, chars) {
  ...
  while (start <= end && chrSymbols.includes(strSymbols[start])) {
    start++;
  }
  while (end >= start && chrSymbols.includes(strSymbols[end])) {
    end--;
  }
...
var utils = {
  ...
  number(key, defaultValue) {
    return this.int(key, defaultValue);
  },
  /**
...
// index.ts
var env_default2 = env_default;
export {
  env_default2 as default
};
